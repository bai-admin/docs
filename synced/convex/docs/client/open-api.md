...
While Convex doesn't have first-party clients for languages such as Go, Java, or
C++, you can generate [OpenAPI](https://swagger.io/specification/)
...
<StepByStep>
  ...
  <Step title="Generate an OpenAPI specification">
...
These snippets include two different files:
